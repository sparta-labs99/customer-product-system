...
-- Admin Data
INSERT INTO admins (name, email, password, phone_number, role, status, created_at, updated_at)
VALUES
    ('최고관리자', 'superadmin@example.com', '$2a$04$JdjUbxUUiB1osaLbFi4Y..SmyTxJkWe0ZtwXR//7nz.1YhmPXmOA2', '010-9999-9999', 'SUPER_ADMIN', 'ACTIVE', NOW(), NOW()),
    ('운영관리자', 'opadmin@example.com', '$2a$04$JdjUbxUUiB1osaLbFi4Y..SmyTxJkWe0ZtwXR//7nz.1YhmPXmOA2', '010-8888-8888', 'OPERATION_ADMIN', 'ACTIVE', NOW(), NOW()); -- <-- 세미콜론(;) 추가 완료
