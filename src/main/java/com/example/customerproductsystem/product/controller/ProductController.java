...
public class ProductController {
    ...
    // 상품 전체 조회
    @GetMapping("/products")
    public ResponseEntity<ApiResponse<Page<GetProductResponse>>> getAllProducts(
    ...
    public ResponseEntity<ApiResponse<UpdateProductResponse>> updateProductStock(
            @PathVariable Long id,
    ...
    public ResponseEntity<ApiResponse<UpdateProductResponse>> updateProductStatus(
            @PathVariable Long id,
